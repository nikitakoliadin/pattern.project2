...
Run jar: `java -D"config.properties"=[your_path] -jar .\pattern.project2-1.1.11.jar`

Example: `java -D"config.properties"="C:\Users\Koliadin Nikita\IdeaProjects\pattern.project2\src\main\resources\config.properties" -jar .\pattern.project2-1.1.11.jar`
