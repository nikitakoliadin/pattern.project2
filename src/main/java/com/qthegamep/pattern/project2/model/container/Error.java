...
public enum Error {
    ...
    SYNC_MONGO_DB_CONNECTOR_ERROR(505),
    ASYNC_MONGO_DB_CONNECTOR_ERROR(506),
    REDIS_POOL_CONNECTOR_ERROR(507),
    REDIS_CLUSTER_CONNECTOR_ERROR(508),
    CLOSE_CLUSTER_REDIS_ERROR(509),
    MONGO_SYNC_SAVE_ERROR_ERROR(510),
    MONGO_ASYNC_SAVE_ERROR_ERROR(511),
    REDIS_NOT_EXISTING_TYPE_ERROR(512),
